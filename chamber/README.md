...
- Fixed Open Graph image URL to be absolute and accessible
...
**Important:** Before deploying, update the og:image URL in `index.html` by replacing `[YOUR_USERNAME]` with your actual GitHub username.
